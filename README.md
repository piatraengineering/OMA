...
.rtfd files (text edit with pictures pasted in don’t play nice with svn, so changed release notes to a word file – probably want to save as pdf before a release
