...
#ifndef _PVCAM_H
#define _PVCAM_H
static const char *_pvcam_h_="$Header: /PVCAM/SourceCommon/pvcam.h 15    5/16/02 5:42p Hgrannis $";
...
/* Class 2 (next available index for class two = 541) */
...
/* Set Continous Clears for Trenton Cameras. This is for cleaning while in external trigger */
/* This is the same as Continous cleans in Trenton manuals. */
...
*/
enum
{ READOUT_NOT_ACTIVE, EXPOSURE_IN_PROGRESS, READOUT_IN_PROGRESS,
...
enum
{ READOUT_PORT1 /* st133 low noise */ ,
  READOUT_PORT2                 /* st133 high capacity */
};
...
/*****************************************************************************/
/* boolean (RETURN)  All functions that return a boolean return TRUE for     */
...
/*****************************************************************************/
  ...
  boolean PV_DECL pl_cam_get_name (int16 cam_num, char_ptr camera_name);
  boolean PV_DECL pl_cam_get_total (int16_ptr totl_cams);
  boolean PV_DECL pl_cam_open (char_ptr camera_name, int16_ptr hcam,
                               int16 o_mode);
...
/*****************************************************************************/
  ...
  boolean PV_DECL pl_ddi_get_ver (uns16_ptr ddi_version);
...
/*****************************************************************************/
  ...
  boolean PV_DECL pl_pvcam_get_ver (uns16_ptr pvcam_version);
  boolean PV_DECL pl_pvcam_init (void);
  boolean PV_DECL pl_pvcam_uninit (void);

  boolean PV_DECL pl_get_param (int16 hcam, uns32 param_id,
                                int16 param_attribute, void_ptr param_value);
  boolean PV_DECL pl_set_param (int16 hcam, uns32 param_id,
...
/*****************************************************************************/
  ...
  boolean PV_DECL pl_exp_get_driver_buffer (int16 hcam,
                                            void_ptr_ptr pixel_stream,
                                            uns32_ptr byte_cnt);
  boolean PV_DECL pl_exp_setup_seq (int16 hcam, uns16 exp_total,
  ...
  boolean PV_DECL pl_exp_setup_cont (int16 hcam, uns16 rgn_total,
                                     rgn_const_ptr rgn_array, int16 exp_mode,
                                     uns32 exposure_time, uns32_ptr exp_bytes,
                                     int16 buffer_mode);
  boolean PV_DECL pl_exp_start_cont (int16 hcam, void_ptr pixel_stream,
                                     uns32 size);
  boolean PV_DECL pl_exp_check_status (int16 hcam, int16_ptr status,
                                       uns32_ptr bytes_arrived);
  boolean PV_DECL pl_exp_check_progress (int16 hcam, int16_ptr status,
                                         uns32_ptr bytes_arrived);
  ...
  boolean PV_DECL pl_exp_finish_seq (int16 hcam, void_ptr pixel_stream,
                                     int16 hbuf);
  boolean PV_DECL pl_exp_unravel (int16 hcam, uns16 exposure,
...
/*****************************************************************************/
  ...
  boolean PV_DECL pl_buf_alloc (int16_ptr hbuf, int16 exp_total,
                                int16 bit_depth, int16 rgn_total,
                                rgn_const_ptr rgn_array);
  boolean PV_DECL pl_buf_get_bits (int16 hbuf, int16_ptr bit_depth);
  boolean PV_DECL pl_buf_get_exp_date (int16 hbuf, int16 exp_num,
  ...
  boolean PV_DECL pl_buf_get_exp_time (int16 hbuf, int16 exp_num,
                                       uns32_ptr exp_msec);
  boolean PV_DECL pl_buf_get_exp_total (int16 hbuf, int16_ptr total_exps);
  boolean PV_DECL pl_buf_get_img_bin (int16 himg, int16_ptr ibin,
                                      int16_ptr jbin);
  boolean PV_DECL pl_buf_get_img_handle (int16 hbuf, int16 exp_num,
                                         int16 img_num, int16_ptr himg);
  boolean PV_DECL pl_buf_get_img_ofs (int16 himg, int16_ptr s_ofs,
                                      int16_ptr p_ofs);
  boolean PV_DECL pl_buf_get_img_ptr (int16 himg, void_ptr_ptr img_addr);
  boolean PV_DECL pl_buf_get_img_size (int16 himg, int16_ptr x_size,
                                       int16_ptr y_size);
...
/*****************************************************************************/
  ...
  boolean PV_DECL pl_dd_get_ver (int16 hcam, uns16_ptr dd_version);
  ...
  boolean PV_DECL pl_ccd_get_frame_capable (int16 hcam,
                                            boolean_ptr frame_capable);
           /* Use PARAM_FRAME_CAPABLE                                        */
  boolean PV_DECL pl_ccd_get_fwell_capacity (int16 hcam,
  ...
  boolean PV_DECL pl_ccd_get_preamp_off_control (int16 hcam,
                                                 uns32_ptr preamp_off_control);
  boolean PV_DECL pl_ccd_set_preamp_off_control (int16 hcam,
  ...
  boolean PV_DECL pl_ccd_get_summing_well (int16 hcam,
                                           boolean_ptr s_well_exists);
           /* Use PARAM_SUMMING_WELL                                         */
  boolean PV_DECL pl_ccd_get_tmp (int16 hcam, int16_ptr cur_tmp);
  boolean PV_DECL pl_ccd_get_tmp_range (int16 hcam, int16_ptr tmp_hi_val,
  ...
  boolean PV_DECL pl_spdtab_get_max_gain (int16 hcam,
  ...
  boolean PV_DECL pl_exp_set_time_seq (int16 hcam, uns16 exp_time);
           /* Use PARAM_EXP_TIME                                             */
  boolean PV_DECL pl_ccd_set_readout_port (int16 hcam,  int16 readout_port); /* JJB */
...
/*****************************************************************************/
  ...
  boolean PV_DECL pl_subsys_do_diag (int16 hcam, uns8 subsys_id,
                                     uns16_ptr err_code);
  boolean PV_DECL pl_subsys_get_id (int16 hcam, uns8 subsys_id,
                                    uns16_ptr part_num, uns8_ptr revision);
  boolean PV_DECL pl_subsys_get_name (int16 hcam, uns8 subsys_id,
